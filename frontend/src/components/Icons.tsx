...
export const IconFilm: React.FC<IconProps> = ({ className }) => (
  <svg
    className={className}
    width="16"
    height="16"
...
export const IconSubtitle: React.FC<IconProps> = ({ className }) => (
  <svg
    className={className}
    width="18"
    height="18"
...
export const IconHDD: React.FC<IconProps> = ({ className }) => (
  <svg
    className={className}
    width="14"
    height="14"
